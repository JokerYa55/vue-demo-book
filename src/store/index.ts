...
export default createStore({
  state: {
    ...
    { 'id': 6, 'isbn': '11111116', 'category': 'Приключения', 'page': 430, 'title': 'Неукротимая планета.', 'author': 'Г. Гаррисон', 'img': '/img/978-5-91878-455-6.jpg' },
    { 'id': 7, 'isbn': '11111117', 'category': 'История', 'page': 430, 'title': 'Огни на курганах.', 'author': 'Г. Гаррисон', 'img': '/img/978-5-91878-455-6.jpg' }],
